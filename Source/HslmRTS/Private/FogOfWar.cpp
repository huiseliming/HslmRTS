...
//typedef TStaticArray<TStaticArray<uint8_t,4>,4> Pixels4x4;
typedef uint8_t* Pixels4x4;


uint8_t Upscale[16 * 16]=
{
	...
	0x00, 0x00, 0x80, 0xFF, // 3
	0x00, 0x00, 0x00, 0x80, // 0x00, 0xff
	0x80, 0x00, 0x00, 0x00, // 0xff, 0x00
	0xFF, 0x80, 0x00, 0x00,
	...
	0x00, 0x80, 0xFF, 0xFF, // 7
	0x80, 0xFF, 0xFF, 0xFF, // 0x00, 0xff
	0xFF, 0xFF, 0xFF, 0xFF, // 0xff, 0xff
	0xFF, 0xFF, 0xFF, 0xFF,
	
	0xFF, 0x80, 0x00, 0x00, // 8
	0x80, 0x00, 0x00, 0x00, // 0xff, 0x00
	0x00, 0x00, 0x00, 0x00, // 0x00, 0x00
	0x00, 0x00, 0x00, 0x00,
	...
	0xFF, 0xFF, 0xFF, 0xFF, // 0xff, 0xff
	0xFF, 0xFF, 0xFF, 0x80, // 0xff, 0x00
	0xFF, 0xFF, 0x80, 0x00,
	
	0xFF, 0x80, 0x00, 0x00, // 12
	0x80, 0x00, 0x00, 0x00, // 0xff, 0x00
	0x00, 0x00, 0x00, 0x80, // 0x00, 0xff
	0x00, 0x00, 0x80, 0xFF,
...
void AFogOfWar::UpdateFogOfWar()
{
	...
	if(bUseUpscaleTexture){
		...
		UpscaleTexture->UpdateTextureRegions(0, 1, &UpscaleTextureUpdateRegion, TextureResolution.X * 4 * 4, 4, TextureBuffer);
	}else{
...
void AFogOfWar::CreateTexture()
{
	...
	if(bUseUpscaleTexture)
	{
		...
		UpscaleTexture = UTexture2D::CreateTransient(TextureResolution.X, TextureResolution.Y);
